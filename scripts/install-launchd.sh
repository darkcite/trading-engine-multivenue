...
# page server). Re-running = graceful restart of the standing engine
# (bootout sends SIGTERM per ExitTimeOut).
set -eu
...
for label in com.multivenue.engine com.multivenue.daily-restart com.multivenue.caffeinate com.multivenue.candles com.multivenue.regime com.multivenue.news com.multivenue.dashboard com.multivenue.archive; do

...
# Requires anthropic >= 1.4.0: 0.122.0's model Literal knew the Fable family as
# `claude-fable-5` alone, so this string and the SDK floor in pyproject.toml
# move together. Verify against the SDK's own list, never against a version
